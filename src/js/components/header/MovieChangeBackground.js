function movieChangeBackground(idElement) {
  ...
  window.addEventListener('scroll', function () {
    ...
    color.r = Math.ceil(
      bgColor1.r > bgColor2.r ? bgColor1.r - tmp : bgColor1.r + tmp,
    );

    tmp = Math.abs(bgColor1.g - bgColor2.g) * percent;
    color.g = Math.ceil(
      bgColor1.g > bgColor2.g ? bgColor1.g - tmp : bgColor1.g + tmp,
    );

    tmp = Math.abs(bgColor1.b - bgColor2.b) * percent;
    color.b = Math.ceil(
      bgColor1.b > bgColor2.b ? bgColor1.b - tmp : bgColor1.b + tmp,
    );

    tmp = Math.abs(bgColor1.a - bgColor2.a) * percent;
    color.a = Math.ceil(
      bgColor1.a > bgColor2.a ? bgColor1.a - tmp : bgColor1.a + tmp,
    );
...
export default movieChangeBackground;
